...
class _CategoryItemState extends State<CategoryItem> {
  ...
  void initState() {
    super.initState();
    _moviesFuture =
        _fetchMoviesByCategory(widget.categoryId, widget.categoryName);
  }

  Future<List<Results>> _fetchMoviesByCategory(
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        setState(() {
                          _moviesFuture = _fetchMoviesByCategory(
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                        ...
                        child:
                            DiscoverMovieItem(movies: snapshot.data![index]));
                  },
                ),
              );
            }
